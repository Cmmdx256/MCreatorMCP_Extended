        ...
        try {
            ...
            while (running.get()) {
                try {
                    ...
                    // Stream was closed or thread was interrupted
                    break;
                }
                
                if (line == null) {
                    // EOF reached (common in GUI or non-interactive Gradle execution)
                    break;
                }
            ...
            if (running.get()) {
                LOG.debug("Stdio reader terminated: {}", e.getMessage());
            }
        } finally {
            running.set(false);
        }
