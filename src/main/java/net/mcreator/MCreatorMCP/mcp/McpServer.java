...
public class McpServer {
    ...
    private void registerDefaultHandlers() {
        ...
        handlers.put("notifications/initialized", this::handleInitialized);
        handlers.put("ping", params -> Map.of());
        handlers.put("server/discover", params -> Map.of("serverInfo", Map.of("name", serverName, "version", serverVersion)));
    ...
    private void handleNotification(JsonRpcMessage message) {
        ...
        if ("initialized".equals(method) || "notifications/initialized".equals(method)) {
    ...
    public static McpTypes.Tool createTool(String name, String description, Map<String, Object> inputSchema) {
