...
public class McpHttpTransport {
    ...
    private class McpHttpHandler implements HttpHandler {
        ...
        public void handle(HttpExchange exchange) throws IOException {
            ...
            exchange.getResponseHeaders().add("Access-Control-Allow-Methods", "POST, GET, OPTIONS, HEAD");
            ...
            if ("GET".equalsIgnoreCase(exchange.getRequestMethod())) {
                ...
                info.put("status", "ok");
                info.put("service", "MCreator MCP Server");
                info.put("version", "2.0.0");
                info.put("message", "MCP HTTP endpoint ready. Send POST requests with JSON-RPC body.");
                sendJsonResponse(exchange, 200, objectMapper.writeValueAsString(info));
                return;
            }
            ...
            try {
                ...
                // Fix improperly escaped JSON from command-line tools
