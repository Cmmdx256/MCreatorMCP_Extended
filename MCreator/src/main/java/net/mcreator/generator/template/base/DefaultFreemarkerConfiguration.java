...
public class DefaultFreemarkerConfiguration extends Configuration {
	...
	private static final Version FTL_CONFIGURATION_VERSION = Configuration.VERSION_2_3_34;
	...
	public DefaultFreemarkerConfiguration() {
		...
		setSharedVariable("javacompress", new TemplateDirectiveModel() {
			@Override
			public void execute(freemarker.core.Environment env, java.util.Map params, TemplateModel[] loopVars,
					TemplateDirectiveBody body) throws TemplateException, java.io.IOException {
				if (body != null) {
					java.io.StringWriter stringWriter = new java.io.StringWriter();
					body.render(stringWriter);
					String result = stringWriter.toString().replaceAll("(?m)^[ \t]*\r?\n", "");
